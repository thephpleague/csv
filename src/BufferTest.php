...
final class BufferTest extends TestCase
{
    ...
    public function it_can_be_updated_by_replacing_or_removing_records_using_its_offset(): void
    {
        ...
        self::assertSame(1, $buffer->update(0, ['date' => '2025-02-08', 'temperature' => '3']));
        self::assertSame(2, $buffer->delete([4, 5, 4]));
...
SQL;
    ...
    public function it_can_update_the_buffer_using_a_record_as_a_list(): void
    {
        ...
        self::assertSame(1, $buffer->update(0, ['2011-01-01', '1', 'bujumbura']));
    ...
    public function it_can_return_the_column_pairs_when_the_buffer_has_a_header(): void
    {
        ...
        self::assertSame($expected, iterator_to_array($buffer->fetchPairs(1, 2)));
        self::assertSame($expected, iterator_to_array($buffer->fetchPairs('temperature', 'place')));
        self::assertSame($expected, iterator_to_array($buffer->fetchPairs(1, 'place')));
        self::assertSame($expected, iterator_to_array($buffer->fetchPairs('temperature', 2)));
    }
